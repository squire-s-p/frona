...
interface SheetContentProps
  ...
  /** A11y title для Radix (можна не показувати користувачу) */
  title?: string
  hideClose?: boolean
}
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, title = "Menu", hideClose = false, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    <SheetPrimitive.Content
      ...
      {...props}
    >
      {/* ✅ A11y fix: Radix вимагає Title всередині Content */}
