    ...
    <>
      ...
      >
        <DialogTrigger asChild>
          {trigger ? trigger : <Button className="rounded-xl">+ Новий проєкт</Button>}
        </DialogTrigger>
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-2">
              ...
              <div className="text-xs text-muted-foreground">
                Єдине обовʼязкове поле (макс 60 символів).
              </div>
            </div>
            ...
            <div className="grid gap-2">
              ...
              <div className="text-xs text-muted-foreground">
                Можна вибрати клієнта або залишити “Без клієнта”.
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button className="rounded-xl" onClick={submit} disabled={isPending || !canSubmit}>
