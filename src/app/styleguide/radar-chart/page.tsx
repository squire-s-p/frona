  ...
  return (
    <Card>
      ...
      <CardContent className="pb-0">
        ...
        >
          <RadarChart data={chartDataSingle}>
    ...
    <Card>
      ...
      <CardContent className="pb-0">
        <ChartContainer
          ...
          className="mx-auto aspect-square max-h-[250px]"
        >
          <RadarChart data={chartDataLinesOnly}>
            <ChartTooltip
              cursor={false}
    ...
    <Card>
      ...
      <CardContent className="pb-0">
        <ChartContainer
          ...
          className="mx-auto aspect-square max-h-[250px]"
        >
          <RadarChart data={chartDataSingleFill}>
            <ChartTooltip cursor={false} content={<ChartTooltipContent />} />
            <PolarGrid
        ...
        >
          <RadarChart data={chartDataSingleFill}>
            <ChartTooltip
              ...
              content={<ChartTooltipContent hideLabel />}
            />
            <PolarGrid className="fill-[var(--color-desktop)] opacity-20" />
            <PolarAngleAxis dataKey="month" />
            <Radar
              dataKey="desktop"
              fill="var(--color-desktop)"
    ...
    <Card>
      ...
      <CardContent className="pb-0">
        <ChartContainer
          ...
          className="mx-auto aspect-square max-h-[250px]"
        >
          <RadarChart data={chartDataMultiple}>
            <ChartTooltip
              cursor={false}
              content={<ChartTooltipContent indicator="line" />}
            />
    ...
    <div className="space-y-10 pr-10 pb-20">
      <div className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground">
          A set of Radar Chart components powered by Recharts.
        </p>
      </div>
