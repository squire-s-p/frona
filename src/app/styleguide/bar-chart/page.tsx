...
function ChartBarInteractive() {
  const [activeChart, setActiveChart] =
    React.useState<keyof typeof chartConfigInteractive>("desktop");
      ...
      <CardHeader className="flex flex-col items-stretch border-b p-0 sm:flex-row">
        ...
        <div className="flex">
          {["desktop", "mobile"].map((key) => {
            const chart = key as keyof typeof chartConfigInteractive;
            return (
              <button
                key={chart}
              ...
              >
                <span className="text-xs text-muted-foreground">
                  {chartConfigInteractive[chart].label}
                </span>
...
function ChartBarDefault() {
  return (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={chartConfigBasic}>
          <BarChart accessibilityLayer data={chartDataBasic}>
            <CartesianGrid vertical={false} />
            <XAxis
              dataKey="month"
              tickLine={false}
...
function ChartBarActive() {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={chartConfigMixed}>
          <BarChart accessibilityLayer data={chartDataActive}>
            <CartesianGrid vertical={false} />
            <XAxis
              dataKey="browser"
              tickLine={false}
...
function ChartBarNegative() {
  return (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={chartConfigNegative}>
          <BarChart accessibilityLayer data={chartDataNegative}>
            <CartesianGrid vertical={false} />
            <ChartTooltip
              cursor={false}
    ...
    <div className="space-y-10 pr-10 pb-20">
      <div className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground">
          A set of Bar Chart components powered by Recharts.
        </p>
      </div>
