...
function ChartAreaDefault() {
  return (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={chartConfigSimple}>
          <AreaChart
            accessibilityLayer
...
function ChartAreaLegend() {
  return (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={chartConfigDouble}>
          <AreaChart
            accessibilityLayer
...
function ChartAreaStackedExpand() {
  return (
    <Card>
      ...
      <CardContent>
        <ChartContainer config={chartConfigExpanded}>
          <AreaChart
            accessibilityLayer
      ...
      <CardContent>
        <ChartContainer config={chartConfigDouble}>
          ...
          >
            ...
            <defs>
              <linearGradient id="fillDesktopGrad" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor="var(--color-desktop)"
                  stopOpacity={0.8}
              ...
              <linearGradient id="fillMobileGrad" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor="var(--color-mobile)"
                  stopOpacity={0.8}
    ...
    <div className="space-y-10 pr-10 pb-20">
      <div className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground">
          A set of Area Chart components powered by Recharts.
        </p>
      </div>
